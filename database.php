<?PHP
	...
	//https://parcel.000webhostapp.com/
	
	date_default_timezone_set('Asia/Kuala_Lumpur');
	
	if($_SERVER['HTTP_HOST']=="localhost" or $_SERVER['HTTP_HOST']=="192.168.0.59")
	{	
		//localhost
		$dbHost = "localhost";	// Database host
		$dbName = "parcel";	// Database name
		$dbUser = "root";		// Database user
		$dbPass = "";			// Database password
	}
	else
	{
		//local live @ hosting 000webhost.com
		$dbHost = "localhost";				// Database host
		$dbName = "id20244007_parcel";		// Database name
		$dbUser = "id20244007_root";		// Database user
		$dbPass = "=&qtI+C57?<(>v2z";			// Database password
	}
