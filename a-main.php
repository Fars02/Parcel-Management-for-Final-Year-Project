...
{	
	$SQL_insert = " 
	INSERT INTO `parcel`(`name`, `tracking_no`, `date`, `status`) 
				VALUES ('$name', '$tracking_no', NOW(), 'Unclaim' )";	
		  ...
		  <div class="w3-padding-16">
			...
			<div class="table-responsive">
				<table class="table table-bordered" id="dataTablex" width="100%" cellspacing="0">
					...
					?>
						<tr>
							<td><span class="w3-text-indigo"><?PHP echo $data["name"]; ?></span><br><span class="w3-text-green"><?PHP echo $data["tracking_no"]; ?></span></td>
							<td>
